...
| struktur isi course dikoreksi | (commit ini) | permintaan pemilik produk — detail course kini **3 item: Topik · Quiz mandiri · Refleksi mandiri** (bukan 4); **di dalam Topik** ada **4 item** pola v1 (📖 Materi · 📝 LKPD · ❓ Quiz · 🪞 Refleksi) via rute baru `course_topik` (kembali → detail course); Quiz/Refleksi mandiri masih placeholder Tahap 4; catatan di layar topik: daftar topik bernomor + jadwal tayang dirancang di Tahap 4 | alur UI 64/64 ✔ |
